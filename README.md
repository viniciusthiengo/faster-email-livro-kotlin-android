...
Projeto apresentado no **Capítulo 11** do livro, mais precisamente o capítulo "Chips para Trabalho com Pequenas Caixas Complexas".

<img src="https://www.thiengo.com.br/img/livro/desenvolvedor-kotlin-android-bibliotecas-para-o-dia-a-dia/github/aplicativo-android-capitulo-11.jpg" alt="Telas do aplicativo Android do capítulo 11" height="360">

**Observação importante:** para o total entendimento do projeto é preciso ter em mãos o livro "Desenvolvedor Kotlin Android" com o capítulo 11 já aberto, pois as explicações detalhadas de todo o projeto deste repositório estarão nesta parte do livro.
